			...
			<div class="row">
                <div class="col-lg-6 col-12">
				  <div class="box">
					...
					<!-- /.box-header -->
					<form class="form" action="{{route('fee_category.update',$fee_category['id'])}}" method="POST">
                        @csrf
						<div class="box-body">
							<div class="form-group">
								...
								<div class="input-group mb-3">
									...
									<input type="text" class="form-control" placeholder="Student Name" name="name" value="{{$fee_category['name']}}">
								</div>
							</div>
						</div>
						<!-- /.box-body -->
